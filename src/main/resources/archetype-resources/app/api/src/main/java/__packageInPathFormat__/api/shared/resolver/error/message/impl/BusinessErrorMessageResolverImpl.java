package ${package}.api.shared.resolver.error.message.impl;

import ${package}.api.shared.resolver.error.message.BusinessErrorMessageResolver;
import ${package}.api.shared.mapping.error.BusinessErrorMessageMappings;
